...
class SDL_Pi_Weather_80422:
        ...
        def __init__(self, pinAnem, pinRain, intAnem, intRain, ADMode ):
                ...
                GPIO.add_event_detect(pinAnem, GPIO.RISING, callback=self.serviceInterruptAnem, bouncetime=10)
                #GPIO.add_event_detect(pinAnem, GPIO.RISING, callback=self.serviceInterruptAnem2)  
                GPIO.add_event_detect(pinRain, GPIO.RISING, callback=self.serviceInterruptRain, bouncetime=300)  

                ADS1115 = 0x01  # 12-bit ADC
                # Select the gain
                ...
                self.ads1015 = ADS1x15(ic=ADS1115, address=0x4B)
        ...
        def current_wind_direction(self):
                ...
                if (SDL_Pi_Weather_80422._ADMode == SDL_MODE_I2C_ADS1015):
                        value = self.ads1015.readADCSingleEnded(0, self.gain, self.sps) # AIN1 wired to wind vane on WeatherPiArduino
        ...
        def serviceInterruptAnem(self,channel):
                ...
                #print(SDL_Pi_Weather_80422._lastWindTime)
        ...
        def serviceInterruptAnem2(self,channel):
                #print "Anem Interrupt Service Routine"
                SDL_Pi_Weather_80422._currentWindCount = SDL_Pi_Weather_80422._currentWindCount+1
