...
#V1.3: Modify by Bubaka@20180320
#V1.31: by Bubaka@20180409 - Oneloop
'''
-------------------- BASE BANDUNG - DEPOK ----------------------
'''
...
SERVER_LOGIN = 'http://secure.getsensync.com/publicsource/led/log?id=xx-bplhd-jabar-dpk'
...
def waitMeasurePM():
	for indx in range(0,100):
		...
		time.sleep(0.8)	#delay(1)
	progress("Measuring...", 1)

def sensorMeasure(number,interval): # Gas sensor Measure
	try:
		heaterControlOn()
		print("Pump ON...")
...
def logo():
	...
	print "    .::::::::::::.     '::::'  :::::'  ::   :: '::::'    ::    ::   ::   ':::'   "       
	print "     .:::....:::.       _____                       __"
	print "     ':::::::::'       |  _  \ ___   ____  ____    |  |____  ____  ____  ____  "
	print "      '::...::'        | |_| |  _ \ / __ \   __|    | |  _ \   _ \   _ \   _ \ "
	print "        '::::'         |  _ <  |_| |\ \__   |_      | | |_| | |_|<  |_| | |_| |"
	print "         '::'          | |_| |  _  | `__ \  |__  '\_| |  _  | |_| |  _  |    / "                        
	print "          ''           |_____/_| |_|\____/_____| \____/_| |_|____/ _| |_|_|\_\ "                       
	print "        .::::.        "                                                                 
	print "         ''''           (c)2015 - 2018 811841<4"
	print "---------------------------------------------------------------------------------"
	print txtcolors.ENDC

def serverLogin():
	print "Connect to Sensync Server..."
	login = urllib.urlopen(SERVER_LOGIN)
	response_login = login.read()
...
print txtcolors.HEADER+"=== Sensync Base Jabar - Depok ==="+txtcolors.ENDC
timeClock()
print txtcolors.OKGREEN + dtime + txtcolors.ENDC
logo()

printlcd("  Sensync Base  ","  V1.3-180320   ")
time.sleep(3)
LcdHome()
...
print txtcolors.HEADER+"=== Sensync Base Jabar - Bandung Rev 1.3-180402 ==="+txtcolors.ENDC
timeClock()
print txtcolors.OKGREEN + dtime + txtcolors.ENDC

printlcd("  Sensync Base  ","  V1.3-180402   ")
time.sleep(3)
LcdHome()
